...
const cores = ['red','white','black','blue','yellow','green']
...
const getGlobalSpinner = (disableSpins = false) => {
  if(!globalSpinner) globalSpinner = new spin({ color: 'blue', succeedColor: `${cor1}`, spinner, disableSpins});
...
const banner = cfonts.render(('CTL|CLIENT'), {
    font: 'pallet',
    align: 'left',
    colors: [`${cor1}`,`${cor2}`],
