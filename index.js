	...
	client.on('chat-update', async (mek) => {
		try {
			...
			var ase = new Date();
                ...
                case 03: waktoonyabro = `Bom Dia ${pushname}鉁╜; break;
                case 04: waktoonyabro = `Bom Dia ${pushname}鉁╜; break;
                case 05: waktoonyabro = `Bom Dia ${pushname}鉁╜; break;
                case 06: waktoonyabro = `Bom Dia ${pushname}鉁╜; break;
                case 07: waktoonyabro = `Bom Dia ${pushname}鉁╜; break;
                case 08: waktoonyabro = `Bom Dia ${pushname}鉁╜; break;
                case 09: waktoonyabro = `Bom Dia ${pushname}鉁╜; break;
                case 10: waktoonyabro = `Bom Dia ${pushname}鉁╜; break;
